...
<div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
   ...
   <a href={`tel:${code.code}`} className="inline-flex font-bold items-center text-slate-950 text-2xl hover:text-blue-600 hover:scale-105 transition-all duration-75">
       {code.code}
